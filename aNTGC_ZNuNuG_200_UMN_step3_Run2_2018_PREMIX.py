...
# with command line options: --nThreads 4 --fileout file:aNTGC_ZNuNuG_200_UMN_PREMIX.root --filein file:aNTGC_ZNuNuG_200_UMN_SIM.root --mc --eventcontent PREMIXRAW --datatier GEN-SIM-DIGI --conditions 106X_upgrade2018_realistic_v15_L1v1 --beamspot Realistic25ns13TeVEarly2018Collision --mc --step DIGI,DATAMIX,L1,DIGI2RAW --procModifiers premix_stage2 --geometry DB:Extended --era Run2_2018 -n 100 --python_filename aNTGC_ZNuNuG_200_UMN_step3_Run2_2018_PREMIX.py --customise Configuration/DataProcessing/Utils.addMonitoring --pileup_input puFile --datamix PreMix --runUnscheduled --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:aNTGC_ZNuNuG_200_UMN_SIM.root'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:aNTGC_ZNuNuG_200_UMN_PREMIX.root'),
...
# Other statements
with open('pileupUL2018.txt') as puListFile:
