...
# with command line options: Configuration/GenProduction/python/aNTGC_GJets.py --nThreads 4 --fileout file:GJets_FlatPtHat_200_GEN.root --mc --eventcontent RAWSIM --datatier GEN --conditions 106X_mc2017_realistic_v8 --beamspot Realistic25ns13TeVEarly2017Collision --mc --step GEN --geometry DB:Extended --era Run2_2017 -n 10 --python_filename aNTGC_GJets_GEN_step1.py --customise Configuration/DataProcessing/Utils.addMonitoring --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/aNTGC_GJets.py nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:GJets_FlatPtHat_200_GEN.root'),
...
process.pho_filter = cms.EDFilter("PythiaFilter",
    ...
    MaxPt = cms.untracked.double(13000.0),
    MinEta = cms.untracked.double(-3.0),
    MinPt = cms.untracked.double(200.0),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.pho_filter)
