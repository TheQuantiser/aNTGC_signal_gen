...
# with command line options: Configuration/GenProduction/gen_fragment_aNTGC_200_UMN.py --nThreads 4 --fileout file:aNTGC_ZNuNuG_200_UMN_GEN.root --mc --eventcontent RAWSIM --datatier GEN --conditions 106X_mc2017_realistic_v8 --beamspot Realistic25ns13TeVEarly2017Collision --mc --step LHE,GEN --geometry DB:Extended --era Run2_2017 -n 100 --python_filename aNTGC_ZNuNuG_200_UMN_step1_Run2_2017_GEN.py --customise Configuration/DataProcessing/Utils.addMonitoring --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/gen_fragment_aNTGC_200_UMN.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:aNTGC_ZNuNuG_200_UMN_GEN.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/store/user/mwadud/aNTGCmet/gridpacks/aNTGC_ZNuNuG_200_UMN_slc7_amd64_gcc820_CMSSW_10_6_28_tarball.tar.xz'),
