...
# with command line options: --nThreads 1 --fileout file:GJets_FlatPtHat_200_MINIAODSIM.root --filein GJets_FlatPtHat_200_AODSIM.root --mc --eventcontent MINIAODSIM --datatier MINIAODSIM --conditions 106X_mc2017_realistic_v8 --step PAT --geometry DB:Extended --era Run2_2017 -n 10 --python_filename aNTGC_GJets_MINIAODSIM_step6.py --customise Configuration/DataProcessing/Utils.addMonitoring --procModifiers run2_miniAOD_UL --runUnscheduled --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('GJets_FlatPtHat_200_AODSIM.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:GJets_FlatPtHat_200_MINIAODSIM.root'),
