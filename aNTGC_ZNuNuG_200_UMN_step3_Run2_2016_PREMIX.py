...
# with command line options: --nThreads 4 --fileout file:aNTGC_ZNuNuG_200_UMN_PREMIX.root --filein file:aNTGC_ZNuNuG_200_UMN_SIM.root --mc --eventcontent PREMIXRAW --datatier GEN-SIM-DIGI --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --mc --step DIGI,DATAMIX,L1,DIGI2RAW --procModifiers premix_stage2 --geometry DB:Extended --era Run2_2016 -n 100 --python_filename aNTGC_ZNuNuG_200_UMN_step3_Run2_2016_PREMIX.py --customise Configuration/DataProcessing/Utils.addMonitoring --pileup_input puFile --datamix PreMix --runUnscheduled --no_exec
...
# Other statements
with open('pileupUL2016.txt') as puListFile:
